...
> The example output above is abbreviated. `SHOW MATERIALIZED VIEWS` also returns the `warehouse`, `refresh_mode`, `refresh_trigger`, `refresh_policy`, and `resource_group` columns.
