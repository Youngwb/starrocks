...
public class GroupExpression {
    ...
    private int planCountRootedThis = 0;
    ...
    public void setPlanCountRootedThis(int count) {
        planCountRootedThis = count;
    }

    public int getPlanCountRootedThis() {
        return planCountRootedThis;
    }
    ...
    public int getRequiredPropertyPlanCount(PhysicalPropertySet requiredProperty) {
        ...
        propertiesPlanCountMap.forEach((k, v) -> {
            if (k.first.equals(requiredProperty)) {
                count.addAndGet(v);
            }
        });
        return count.get();
